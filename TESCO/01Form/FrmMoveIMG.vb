...
Public Class FrmMoveIMG
    ...
    Private Sub CmdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSearch.Click
        ...
        sql = " SELECT     CLUBCARD_NO FROM TBL_MEMBER_CLUBCARD  WITH (NOLOCK)   " & _
                        "  WHERE CUSTOMER_USE_STATUS =0   and   ( IMG_FLAG='IMGOK' )" & _
                        " and convert(varchar(10),IMG_DATE,20)  = '" & DDATE & "'   " & _
                        " order by CUSTID "
        ...
        If i = True Then
            If rsXML.Tables(0).Rows.Count <> 0 Then
                For x = 0 To rsXML.Tables(0).Rows.Count - 1
                    ...
                    LstSignIMG.Items.Add(Trim(rsXML.Tables(0).Rows(x)("CLUBCARD_NO").ToString))
                    'End If
        ...
        sql = " SELECT     CLUBCARD_NO FROM TBL_MEMBER_CLUBCARD   WITH (NOLOCK)  " & _
                         "  WHERE CUSTOMER_USE_STATUS =6   and   ( IMG_FLAG='IMGOK' )" & _
                         " and convert(varchar(10),IMG_DATE,20)  = '" & DDATE & "'   " & _
                         " order by CUSTID "
        ...
        If i = True Then
            If rsXML.Tables(0).Rows.Count <> 0 Then
                For x = 0 To rsXML.Tables(0).Rows.Count - 1
                    ...
                    'If Dir(IMGtarget, FileAttribute.Archive) <> "" Then
                    LstUNsignIMG.Items.Add(Trim(rsXML.Tables(0).Rows(x)("CLUBCARD_NO").ToString))
                    'End If
...
error_Handler:
    ...
    Private Sub CmdSubmit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdSubmit.Click
        ...
        For i = 0 To LstSignIMG.Items.Count - 1
            If Dir(Txtsourcesign.Text & Mid(LstSignIMG.Items(i), 1, 18) & ".pdf") = "" Then
                GoTo nextlp
            End If
            File.Move(Txtsourcesign.Text & Mid(LstSignIMG.Items(i), 1, 18) & ".pdf", target & Mid(LstSignIMG.Items(i), 1, 18) & ".pdf")
nextlp: Next
        'Call copyIMG()
        ...
        'Dim target As String
        target = TxtTarget.Text & "UNSIGNED-"

       
        For i = 0 To LstUNsignIMG.Items.Count - 1
            If Dir(TxtsourceUnsign.Text & "unsigned-" & Mid(LstUNsignIMG.Items(i), 1, 18) & ".pdf") = "" Then
                GoTo nextlp1
            End If
            File.Move(TxtsourceUnsign.Text & "unsigned-" & Mid(LstUNsignIMG.Items(i), 1, 18) & ".pdf", target & Mid(LstUNsignIMG.Items(i), 1, 18) & ".pdf")
...
" FROM TBL_MEMBER_CLUBCARD   WITH (NOLOCK)  inner join TBL_MAILBAG  WITH (NOLOCK)   on TBL_MEMBER_CLUBCARD.MAILBAG_ID  =TBL_MAILBAG .MAILBAG_ID  " & _
